...
class FigureParameter {
  ...
  static setFigureParameter(figurename, index, figparam) {
    if (!(figparam instanceof FigureParameter))
      throw new Error(
        "Third argument to FigureParameter.setFigureParameter is not FigureParameter: " +
          figparam
      );
    if (
...
go.Shape.defineFigureGenerator("ChamferedRectangle", (shape, w, h) => {
  ...
  if (isNaN(param1) || param1 < 0) param1 = 12;
...
go.Shape.defineFigureGenerator("AsteriskLine", (shape, w, h) => {
  ...
  return new go.Geometry().add(
    new go.PathFigure(offset * w, (1 - offset) * h, false)
      .add(
        new go.PathSegment(go.SegmentType.Line, (1 - offset) * w, offset * h)
      )
...
FigureParameter.setFigureParameter(
  "Parallelogram1",
  0,
  new FigureParameter("Indent", 0.1, -0.99, 0.99)
);
...
FigureParameter.setFigureParameter(
  "Trapezoid1",
  0,
  new FigureParameter("Indent", 0.2, -0.99, 0.99)
);
...
FigureParameter.setFigureParameter(
  "Trapezoid2",
  0,
  new FigureParameter("Indent", 20, -Infinity, Infinity)
);
...
go.Shape.defineFigureGenerator("Pentagon", (shape, w, h) => {
  ...
  for (let i = 1; i < 5; i++) {
    fig.add(
      new go.PathSegment(go.SegmentType.Line, points[i].x * w, points[i].y * h)
    );
  }
  fig.add(
    new go.PathSegment(
...
FigureParameter.setFigureParameter(
  "FramedRectangle",
  0,
  new FigureParameter("ThicknessX", 8)
);
FigureParameter.setFigureParameter(
  "FramedRectangle",
  1,
  new FigureParameter("ThicknessY", 8)
);
go.Shape.defineFigureGenerator("FramedRectangle", (shape, w, h) => {
  ...
  if (param1 < w / 2 && param2 < h / 2) {
    ...
    fig.add(
      new go.PathSegment(go.SegmentType.Line, w - param1, param2).close()
    );
  }
...
FigureParameter.setFigureParameter(
  "Ring",
  0,
  new FigureParameter("Thickness", 8)
);
go.Shape.defineFigureGenerator("Ring", (shape, w, h) => {
  ...
  geo.add(fig);
  fig.add(
    new go.PathSegment(go.SegmentType.Arc, 0, 360, rad, rad, rad, rad).close()
  );
...
FigureParameter.setFigureParameter(
  "Pie",
  0,
  new FigureParameter("Start", 0, -360, 360)
);
FigureParameter.setFigureParameter(
  "Pie",
  1,
  new FigureParameter("Sweep", 315, -360, 360)
);
...
FigureParameter.setFigureParameter(
  "ThickCross",
  0,
  new FigureParameter("Thickness", 30)
);
...
FigureParameter.setFigureParameter(
  "SquareIBeam",
  0,
  new FigureParameter("BeamWidth", 0.2, 0.1, 0.9)
);
go.Shape.defineFigureGenerator("SquareIBeam", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.SegmentType.Line, (0.5 + param1 / 2) * w, param1 * h)
  );
  fig.add(
    new go.PathSegment(
      go.SegmentType.Line,
...
FigureParameter.setFigureParameter(
  "RoundedIBeam",
  0,
  new FigureParameter("Curviness", 0.5, 0.05, 0.65)
);
...
go.Shape.defineFigureGenerator("YinYang", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.SegmentType.Move, (centerx + radius) * w, centery * h)
  );
  fig.add(
    new go.PathSegment(
      go.SegmentType.Arc,
...
go.Shape.defineFigureGenerator("NotAllowed", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.SegmentType.Line, endOfArrow.x * w, endOfArrow.y * h)
  );
  fig.add(
    new go.PathSegment(
      go.SegmentType.Bezier,
...
go.Shape.defineFigureGenerator("GenderMale", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(
      go.SegmentType.Line,
      (startOfArrow.x * 0.1 + 0.95 * 0.9) * w,
      startOfArrow.y * 0.1 * h
    )
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, 0.85 * w, startOfArrow.y * 0.1 * h)
  );
...
FigureParameter.setFigureParameter(
  "Arrow",
  0,
  new FigureParameter("ArrowheadWidth", 0.3, 0.01, 0.99)
);
FigureParameter.setFigureParameter(
  "Arrow",
  1,
  new FigureParameter("TailHeight", 0.3, 0.01, 0.99)
);
...
FigureParameter.setFigureParameter(
  "Arrow2",
  0,
  new FigureParameter("ArrowheadWidth", 30)
);
FigureParameter.setFigureParameter(
  "Arrow2",
  1,
  new FigureParameter("TailHeight", 30)
);
...
FigureParameter.setFigureParameter(
  "DoubleEndArrow",
  0,
  new FigureParameter("ConnecterHeight", 0.3, 0.01, 0.99)
);
...
FigureParameter.setFigureParameter(
  "DoubleEndArrow2",
  0,
  new FigureParameter("ConnecterHeight", 40)
);
FigureParameter.setFigureParameter(
  "DoubleEndArrow2",
  1,
  new FigureParameter("ArrowHeight", 100)
);
...
FigureParameter.setFigureParameter(
  "IBeamArrow",
  0,
  new FigureParameter("ConnectorHeight", 0.3, 0.01, 0.99)
);
...
FigureParameter.setFigureParameter(
  "IBeamArrow2",
  0,
  new FigureParameter("ConnectorHeight", 40)
);
FigureParameter.setFigureParameter(
  "IBeamArrow2",
  1,
  new FigureParameter("BeamArrowHeight", 100)
);
...
FigureParameter.setFigureParameter(
  "Pointer",
  0,
  new FigureParameter("BackPoint", 0.1, 0, 0.2)
);
...
FigureParameter.setFigureParameter(
  "RoundedPointer",
  0,
  new FigureParameter("RoundedEdged", 0.3, 0, 0.5)
);
...
FigureParameter.setFigureParameter(
  "SplitEndArrow",
  0,
  new FigureParameter("TailHeight", 0.4, 0.01, 0.99)
);
...
FigureParameter.setFigureParameter(
  "SplitEndArrow2",
  0,
  new FigureParameter("TailHeight", 40)
);
...
FigureParameter.setFigureParameter(
  "SquareArrow",
  0,
  new FigureParameter("ArrowPoint", 0.7, 0.2, 0.9)
);
...
FigureParameter.setFigureParameter(
  "Card",
  0,
  new FigureParameter("CornerCutoutSize", 0.2, 0.1, 0.9)
);
...
go.Shape.defineFigureGenerator("Junction", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.SegmentType.Move, small * w, (small + dist) * h)
  );
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, (small + dist) * w, small * h)
  );
  return geo;
});
...
go.Shape.defineFigureGenerator("OfflineStorage", (shape, w, h) => {
  ...
  geo.add(fig2);
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, (1 - 0.5 * param1) * w, param1 * h)
  );
...
go.Shape.defineFigureGenerator("Fallout", (shape, w, h) => {
  ...
  // Containing circle
  fig.add(
    new go.PathSegment(go.SegmentType.Arc, 180, 360, w / 2, h / 2, w / 2, h / 2)
  );
...
go.Shape.defineFigureGenerator("BpmnTaskUser", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, (1 - 0.335) * w, (1 - 0.405) * h)
  );
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, (1 - 0.335) * w, (1 - 0.555) * h)
  );
  fig2.add(
    new go.PathSegment(
      go.SegmentType.Bezier,
  ...
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, (1 - 0.365) * w, (1 - 0.595) * h)
  );
  // Neckline
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, (1 - 0.335) * w, (1 - 0.555) * h)
...
go.Shape.defineFigureGenerator("Caution", (shape, w, h) => {
  ...
  geo.add(fig);
  fig.add(
    new go.PathSegment(go.SegmentType.Bezier, 0.1 * w, 0.8 * h, 0, h, 0, h)
  );
  ...
  fig.add(
    new go.PathSegment(go.SegmentType.Move, (0.5 - radius) * w, 0.875 * h)
  );
  fig.add(
    new go.PathSegment(
      go.SegmentType.Arc,
...
go.Shape.defineFigureGenerator("CentrifugalPump", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.SegmentType.Bezier, 0.4 * w, h, 0, h, 0.4 * w, h)
  );
  fig.add(
    new go.PathSegment(
      go.SegmentType.Bezier,
...
go.Shape.defineFigureGenerator("Gear", (shape, w, h) =>
  new go.Geometry().add(
    new go.PathFigure(0.9375 * w, 0.56246875 * h, true)
      ...
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.8566875 * w, 0.23796875 * h)
      )
      .add(new go.PathSegment(go.SegmentType.Line, 0.76825 * w, 0.14959375 * h))
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.67596875 * w, 0.24184375 * h)
      )
      .add(
        new go.PathSegment(
          go.SegmentType.Bezier,
      ...
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.2379375 * w, 0.14959375 * h)
      )
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.14953125 * w, 0.2379375 * h)
      )
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.23934375 * w, 0.3278125 * h)
      )
      .add(
        new go.PathSegment(
          go.SegmentType.Bezier,
      ...
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.3316875 * w, 0.76296875 * h)
      )
      .add(
        new go.PathSegment(
          go.SegmentType.Bezier,
      ...
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.76828125 * w, 0.8566875 * h)
      )
      .add(new go.PathSegment(go.SegmentType.Line, 0.85671875 * w, 0.76825 * h))
      .add(
        new go.PathSegment(go.SegmentType.Line, 0.76065625 * w, 0.67221875 * h)
      )
      .add(
        new go.PathSegment(
          go.SegmentType.Bezier,
...
go.Shape.defineFigureGenerator("Building", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, 0.322 * w, 0.85 * h).close()
  );
  ...
  fig3.add(
    new go.PathSegment(go.SegmentType.Line, 0.598 * w, 0.85 * h).close()
  );
  ...
  fig4.add(
    new go.PathSegment(go.SegmentType.Line, 0.874 * w, 0.85 * h).close()
  );
  // the top inner triangle
  const fig5 = new go.PathFigure(0.5 * w, 0.1 * h, false); // is filled in our not
  geo.add(fig5);
  fig5.add(
    new go.PathSegment(go.SegmentType.Line, (0.046 + 0.15) * w, 0.3 * h)
  );
  fig5.add(
    new go.PathSegment(
      go.SegmentType.Line,
...
go.Shape.defineFigureGenerator("5Bars", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.184, h * (1 - 0.184)).close()
  );
  ...
  fig3.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.388, h * (1 - 0.184 * 2))
  );
  ...
  geo.add(fig4);
  fig4.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.408, h * (1 - 0.184 * 2))
  );
  fig4.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.592, h * (1 - 0.184 * 3))
  );
  ...
  geo.add(fig5);
  fig5.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.612, h * (1 - 0.184 * 3))
  );
  fig5.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.796, h * (1 - 0.184 * 4))
  );
  ...
  geo.add(fig6);
  fig6.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.816, h * (1 - 0.184 * 4))
  );
...
go.Shape.defineFigureGenerator("PC", (shape, w, h) => {
  ...
  fig3.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.055, h * 0.16).close()
  );
  ...
  fig4.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.055, h * 0.21).close()
  );
...
go.Shape.defineFigureGenerator("FilmTape", (shape, w, h) => {
  ...
  geo.add(fig);
  fig.add(
    new go.PathSegment(go.SegmentType.Arc, 270, 180, w * 0, w * 0.3, w * 0.055)
  ); // left semi-circle
  fig.add(new go.PathSegment(go.SegmentType.Line, 0, h * 1));
  fig.add(new go.PathSegment(go.SegmentType.Line, w * 0.08, h * 1));
  fig.add(new go.PathSegment(go.SegmentType.Line, w * 0.08, h * 0.95));
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 1), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 1), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 2), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 2), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 3), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 3), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 4), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 4), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 5), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 5), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 6), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 6), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 7), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 7), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 8), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 8), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 9), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 9), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 10), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 10), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 11), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 11), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 12), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 12), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 13), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 13), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 14), h * 1)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 14), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 15), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * (0.08 + 0.056 * 15), h * 1)
  );
  ...
  fig2.add(
    new go.PathSegment(go.SegmentType.Arc, 270, -180, w * 1, w * 0.3, w * 0.055)
  ); // right semi circle
  ...
  const fig4 = new go.PathFigure(
    w * (0.11 + 0.24133333 * 1 + 0.028 * 1),
    h * 0.1,
    false
  ); // is filled in our not
  geo.add(fig4);
  fig4.add(
    new go.PathSegment(
      go.SegmentType.Line,
      w * (0.11 + 0.24133333 * 2 + 0.028 * 1),
      h * 0.1
    )
  );
  fig4.add(
...
go.Shape.defineFigureGenerator("Terminal", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.275, h * 0.25).close()
  );
...
go.Shape.defineFigureGenerator("Download", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.SegmentType.Line, w * 0, h * (1 - third)).close()
  );
  // arrow pointing down
...
go.Shape.defineFigureGenerator("Drink", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.SegmentType.Line, w * 0.345, h * 0.97).close()
  );
  return geo;
});
